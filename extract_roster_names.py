...
def main() -> None:
    parser = argparse.ArgumentParser(description="Extract roster from NBA 2K26 RosterViewer screenshots")
    ...
    if not roster_entries:
        ...
        print("Use extract_standings.py for standings extraction.")
        return
